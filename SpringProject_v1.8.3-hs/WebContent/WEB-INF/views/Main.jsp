...
<c:if test="${!empty sessionScope.id}">
	<body id="loginok">
		...
		<div id="menu">
			...
			<a href="/chat.do?offset=0&pagelink=1" id="a4">
				<span class="menu d">
				...
				<table align="center" id="logo">
					<tr>
						<td colspan="2" align="center"><img
							src="/resources/img/SOLNAMU.png" /></td>
					</tr>

					<tr>
						<td><label><b>아이디</b></label><br /> <br /> <input
							type="text" id="id" size="50" maxlength="15" /><br /> <br />
					</tr>
					<tr>
						<td><label><b>비밀번호</b></label><br /> <br /> <input
							type="password" id="pw" size="50" maxlength="15" /><br />
					</tr>

					<tr>
						<td colspan="2" align="right"><p>
								<a id="a5" href="${signUpUrl}">회원가입</a>
							</p></td>
					</tr>
					<tr>
