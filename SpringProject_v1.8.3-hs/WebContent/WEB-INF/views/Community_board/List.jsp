...
<body>
	...
	<table align="center" cellpadding="1" width="700" border="0">
		<tr>
			...
			<td><form action="/community_board_write_form.do" method="get">
	...
	<table align="center" cellpadding="1" width="700" border="1">
		<tr>
			...
			<td width="80"><p align="center">분류</p></td>
		...
		<c:forEach var="board" items="${boardList}">
			<tr>
				...
				<td width="80"><p align="center">${board.getKategorie()}</p></td>
				<td width="100"><p align="center">${board.getName()}</p></td>
				<td width="320">
					<p align="center">
						<a href="community_board_view_contents.do?no=${board.getNo()}&offset=${offset}&pagelink=${pagelink}">
	...
	<form action="/community_board_serch_list.do" method="GET" >
